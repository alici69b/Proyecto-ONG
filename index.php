...
<body class=" animacion-entrada bg-[#f4f9fa] " id="inicio">
    ...
    <!-- ola del inicio -->
        ...
        <section class="bg-[#f4f9fa] py-24">
            ...
            <div class=" max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 mt-10 gap-6 p">
                <!-- CARD 1 -->
                <div class="relative bg-white rounded-4xl p-8 shadow-lg md:col-span-2">
                    <div class="absolute -top-3 -left-0 w-10 h-10 bg-[#00a5cf] text-white rounded-full flex items-center justify-center font-bold shadow-lg">1</div>
                ...
                <!-- CARD 2 -->
                <div class="relative bg-white rounded-4xl p-8 shadow-lg">
                    <div class="absolute -top-3 left-205 w-10 h-10 bg-[#00a5cf] text-white rounded-full flex items-center justify-center font-bold shadow-lg">2</div>
                ...
                <!-- CARD 4 -->
                <div class="relative bg-white rounded-4xl p-8 shadow-lg ">
                    <div class="absolute -bottom-2 -left-0 w-10 h-10 bg-[#00a5cf] text-white rounded-full flex items-center justify-center font-bold shadow-lg">4</div>
                ...
                <!-- CARD 3 -->
                <div class=" relative bg-white rounded-4xl p-8 shadow-lg md:col-span-2">
                    <div class="absolute -bottom-2 -right-0 w-10 h-10 bg-[#00a5cf] text-white rounded-full flex items-center justify-center font-bold shadow-lg">3</div>
    ...
    <!-- Tarjetas donde se explican sobre que pueden escribir los que tienen problemas -->
            <section class=" min-h-150 max-w-full pb-25 text-white mt-30">
                ...
                <div class="  max-w-7xl mx-auto pb-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center p-6 ">
                    <!-- CARD 1 -->
                    <div class="bg-white/10 backdrop-blur-md border border-white/20  flex flex-col items-center gap-4   rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition transform duration-300 m-2 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:scale-105 ">
                        <!-- Icono Estudios -->
                        ...
                        <h4 ><b>Estudios</b></h4>
                        <p class="text-white">Carreras, cursos, certificaciones abandonadas</p>
                </div>
                    <!-- CARD 2 -->
                    <div class="p-8 flex flex-col items-center gap-4 border-white bg-white/10 backdrop-blur-md border border-white/20 rounded-lg hover:shadow-lg hover:-translate-y-1 transition transform duration-300 m-2 ease-[cubic-bezier(0.34,1.56,0.64,1)]  hover:scale-105  ">
                        <!-- Icono Proyectos -->
                        ...
                        <h4 ><b>Proyectos</b></h4>
                        <p class="text-white">Apps, negocios, ideas que no llegaron a lanzarse</p>
                    </div>
                    <!-- CARD 3 -->
                    <div class="p-8 flex flex-col items-center gap-4 border-white bg-white/10 backdrop-blur-md border border-white/20 rounded-lg hover:shadow-lg hover:-translate-y-1 transition transform duration-300 m-2 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:scale-105 ">
                        <!-- Icono Hábitos -->
                        ...
                        <h4 ><b>Hábitos</b></h4>
                        <p class="text-white">Rutinas de ejercicio, lectura, alimentación</p>
                    </div>
                    <!-- CARD 4 -->
                    <div class="p-8 flex flex-col items-center gap-4 border-white bg-white/10 backdrop-blur-md border border-white/20 rounded-lg  hover:shadow-lg hover:-translate-y-1 transition transform duration-300 m-2 ease-[cubic-bezier(0.34,1.56,0.64,1)]  hover:scale-105  ">
                        <!-- Icono sueños -->
                        ...
                        <h4 ><b>Sueños</b></h4>
                        <p class="text-white">Esas metas personales que dejaste de lado</p>
                    </div>
                </div>
                </div>
            </section>
