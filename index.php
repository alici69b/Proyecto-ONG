        ...
        <section class="bg-[#f4f9fa] py-24">
            <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div class="sticky top-24 bg-white rounded-lg p-8 shadow-lg">
                    <div class="absolute -top-5 left-6 w-10 h-10  flex items-center justify-center rounded-full font-bold bg-[#8CBEB2] text-white">1</div>
                ...
                <div class="sticky top-32 bg-white rounded-lg p-8 shadow-lg">
                    <div class="absolute -top-5 left-6 w-10 h-10   flex items-center justify-center rounded-full font-bold  bg-[#8CBEB2] text-white">2</div>
                ...
                <div class="sticky top-40 bg-white rounded-lg p-8 shadow-lg">
                    <div class="absolute -top-5 left-6 w-10 h-10   flex items-center justify-center rounded-full font-bold  bg-[#8CBEB2] text-white">3</div>
                ...
                <div class="sticky top-48 bg-white rounded-lg p-8 shadow-lg">
                    <div class="absolute -top-5 left-6 w-10 h-10   flex items-center justify-center rounded-full font-bold  bg-[#8CBEB2] text-white">4</div>
