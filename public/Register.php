...
<body class="">
  ...
  <div class="hidden lg:flex lg:w-1/2 bg-linear-to-r from-red-500 to-red-100 min-h-200   items-center justify-center text-white  ">
  ...
  <div class="flex w-full flex-col justify-center px-8 md:px-16 lg:w-1/2 xl:px-24 bg-white">
    ...
    <div class="flex gap-2 mb-8 bg-[#ffe7e5] p-1 rounded-xl">
        ...
        text-black hover:text-white hover:bg-[#ff3b30]">
        Necesito ayuda
        </label>
    ...
    <div class="hidden peer-checked/usuario:block animate-in fade-in duration-300">
        ...
        <select class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white focus:ring-2 focus:ring-[#ff3b30] outline-none">
    ...
    <div class="hidden peer-checked/voluntario:block animate-in fade-in duration-300">
        ...
        <select class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white focus:ring-2 focus:ring-indigo-500 outline-none ">
      ...
      <form class="space-y-5">
        <div>
          <label class="block text-sm font-medium text-slate-700 mb-2">Tu nombre</label>
          <input type="text" placeholder="¿Cómo te llamas?" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#ff3b30] focus:border-transparent transition-all" required>
        </div>

        <div>
          <label class="block text-sm font-medium text-slate-700 mb-2">Email</label>
          <input type="email" placeholder="tu@email.com" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#ff3b30] focus:border-transparent transition-all" required>
        </div>

        <div>
          <label class="block text-sm font-medium text-slate-700 mb-2">Contraseña</label>
          <div class="relative">
            <input type="password" placeholder="Mínimo 8 caracteres" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#ff3b30] focus:border-transparent transition-all" required>
        ...
        <button type="submit" class="w-full bg-[#ff3b30] hover:bg-black text-white font-semibold py-4 rounded-xl shadow-lg  transition-all flex items-center justify-center gap-2 bg-[#ff3b30]">
        ...
        <p class="text-xs text-center text-slate-400 mt-4 italic">
          "Aquí empieza tu RESET. No tienes que hacerlo solo/a."
        </p>
      </form>

      <p class="mt-10 text-center text-sm text-gray-600">
        ¿Ya tienes cuenta? <a href="../public/Register.php" class="font-bold text-[#ff3b30] hover:underline">Inicia Sesión</a>
      </p>
