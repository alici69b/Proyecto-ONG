...
<body class="font-sans">
    ...
    <div class="max-w-7xl mx-auto px-4 py-7 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center pb-30">
        ...
        <div class="relative bg-white rounded-lg p-8 flex flex-col items-center gap-4 hover:shadow-lg hover:-translate-y-1 transition duration-300">
            ...
            <div class="hidden lg:flex absolute -top-6 left-1/2 -translate-x-2/4 w-10 h-10 rounded-full bg-gray-900 text-white items-center justify-center font-bold">1</div>
        ...
        <div class="relative bg-white rounded-lg p-8 flex flex-col items-center gap-4 hover:shadow-lg hover:-translate-y-1 transition duration-300">
            ...
            <div class="hidden lg:flex absolute -top-6 left-1/2 -translate-x-2/4 w-10 h-10 rounded-full bg-gray-900 text-white items-center justify-center font-bold">2</div>
        ...
        <div class="relative bg-white rounded-lg p-8 flex flex-col items-center gap-4 hover:shadow-lg hover:-translate-y-1 transition duration-300">
            ...
            lg:absolute lg:-top-6 lg:left-1/2 lg:-translate-x-1/2
            w-10 h-10 rounded-full bg-gray-900 text-white 
            items-center justify-center font-bold z-10">3</div>
        ...
        <div class="relative bg-white rounded-lg p-8 flex flex-col items-center gap-4 hover:shadow-lg hover:-translate-y-1 transition duration-300">
            ...
            <div class="hidden lg:flex absolute -top-6 left-1/2 -translate-x-2/4 w-10 h-10 rounded-full bg-gray-900 text-white items-center justify-center font-bold">4</div>
