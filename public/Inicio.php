...
<body class="font-serif">
    ...
    <section class="bg-[#f2f2f2] min-h-130 max-w-full ">
        ...
        <div class=" max-w-7xl mx-auto px-4 py-7 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center mt-15">
            <div class="flex flex-col items-center gap-4 border-white bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition transform duration-300 m-2">
                <!-- Icono Estudios -->
