    ...
    <div class="mx-auto w-full max-w-md">
      ...
      <form action="#" class="space-y-6">
        <div>
          ...
          <input type="email" placeholder="tu@email.com" class="mt-1 w-full rounded-lg border border-gray-300 p-3 focus:border-[#ff3b30] focus:outline-none focus:ring-1 focus:ring-[#ff3b30]" />
        </div>

        <div class="relative">
          <label class="block text-sm font-medium text-gray-700">Contraseña</label>
          <input type="password" placeholder="••••••••" class="mt-1 w-full rounded-lg border border-gray-300 p-3 focus:border-[#ff3b30] focus:outline-none focus:ring-1 focus:ring-[#ff3b30]" />
        ...
        <div class="flex items-center justify-between">
          <label class="flex items-center text-sm text-gray-600">
            <input type="checkbox" class="mr-2 h-4 w-4 rounded border-gray-300 text-[#ff3b30] focus:ring-[#ff3b30]" />
            Recordarme
          </label>
          <a href="#" class="text-sm font-medium text-[#ff3b30] hover:underline">¿Olvidaste tu contraseña?</a>
        </div>

        <button type="submit" class="flex w-full items-center justify-center gap-2 rounded-lg bg-[#ff3b30] p-3 font-semibold text-white transition hover:bg-black">
      ...
      <p class="mt-10 text-center text-sm text-gray-600">
        ¿No tienes cuenta? <a href="../public/Register.php" class="font-bold text-[#ff3b30] hover:underline">Regístrate aquí</a>
      </p>
    </div>
  </div>

  <div class="hidden lg:flex lg:w-1/2 bg-linear-to-r from-red-100 to-red-500 min-h-150  py-15 items-center justify-center text-white p-12">
