    <nav class="absolute top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl bg-white/60 backdrop-blur-md border border-white/10 shadow-lg rounded-full z-[100] px-6 py-2 flex items-center justify-between">
        ...
        <div class="flex-1 flex justify-end items-center gap-3">
            <div class="flex items-center gap-2 bg-gray-100/80 hover:bg-gray-200/80 transition px-3 py-1.5 rounded-full border border-gray-200 cursor-pointer">
                <img src="../../../public/img/<?php echo $voluntario['foto_perfil']; ?>" 
                     class="w-9 h-9 aspect-square object-cover rounded-full shadow-sm" 
                     alt="Perfil">
                <span class="hidden sm:inline text-gray-700 text-sm font-bold">
                    <?php echo ucfirst(htmlspecialchars($voluntario['nombre'])); ?>
                </span>
            </div>

            <div class="md:hidden flex items-center">
                <input type="checkbox" id="menu-toggle" class="peer hidden" />
                <label for="menu-toggle" class="cursor-pointer p-2 rounded-full hover:bg-gray-100 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#004e64" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>
                </label>
                ...
                <div class="absolute top-full left-0 right-0 mt-4 mx-2 bg-white rounded-2xl shadow-2xl border border-gray-100 flex-col hidden peer-checked:flex overflow-hidden animate-in fade-in slide-in-from-top-4 duration-300">
                    <a class="px-6 py-4 hover:bg-gray-50 text-gray-700 border-b border-gray-50" href="Casos.php">Casos</a>
                    <a class="px-6 py-4 hover:bg-gray-50 text-gray-700 border-b border-gray-50" href="Historys.php">Historias</a>
                    <div class="bg-gray-50 p-4">
                        <a class="w-full block py-3 text-center bg-red-50 text-red-600 rounded-xl font-bold border border-red-100" href="Logout.php">Cerrar Sesión</a>
                    </div>
                </div>
            </div>
        </div>
