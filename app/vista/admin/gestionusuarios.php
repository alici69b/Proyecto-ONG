                            ...
                            <?php else: ?>
                                ...
                                <tr class="hover:bg-slate-50/80 transition-all group">
                                    <td class="px-8 py-4 flex items-center gap-4">
                                        <div class="w-10 h-10 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white flex items-center justify-center font-bold text-xs shadow-md shadow-indigo-200">
