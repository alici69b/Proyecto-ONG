    ...
    <div class="flex flex-1 ">
        <aside class="w-64 bg-[#004e64] text-blue-100 flex flex-col p-6 gap-8 ">
            ...
            <nav class="flex flex-col gap-2">
                <a href="#" class="bg-linear-to-r from-[#00a5cf] to-[#9fffcb] text-[#004e64] flex items-center gap-3 px-4 py-3 rounded-xl shadow-lg shadow-black/20 text-sm font-extrabold">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/10 transition-all text-sm group">
        ...
        <main class="flex-1 p-8 md:p-12 overflow-y-auto">
            <div class="max-w-6xl mx-auto">
                ...
                <!-- resets pendientes -->
                <div class="bg-white rounded-4xl shadow-xl shadow-slate-200/60 border border-slate-100 p-8 md:p-10 w-full relative overflow-hidden">
                    <div class="absolute top-0 right-0 w-24 h-24  rounded-bl-[2.5rem] -mr-10 -mt-10 z-0 bg-yellow-50" ></div>
                ...
                <!-- reests completados -->
                <div class="bg-white rounded-4xl shadow-xl shadow-slate-200/60 border border-slate-100 p-8 md:p-10 w-full relative overflow-hidden">
                    <div class="absolute top-0 right-0 w-24 h-24  rounded-bl-[2.5rem] -mr-10 -mt-10 z-0 bg-green-50" ></div>
                    <div class="font-semibold text-4xl md:text-5xl mt-5">89</div>
                ...
                <!-- Voluntarios -->
                <div class="bg-white rounded-4xl shadow-xl shadow-slate-200/60 border border-slate-100 p-8 md:p-10 w-full relative overflow-hidden">
                    <div class="absolute top-0 right-0 w-24 h-24  rounded-bl-[2.5rem] -mr-10 -mt-10 z-0 bg-blue-50" ></div>
                    <div class="font-semibold text-4xl md:text-5xl mt-5">9</div>
